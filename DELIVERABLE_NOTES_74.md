...
- Simplified public marketing surfaces:
  ...
  - destinations: rewrote internal/growth copy into customer-facing language and removed extra
    growth sections
- Footer remains public-only through the new chrome layer.

## Important

- This patch was prepared directly on the codebase and was **not fully validated with
  `npm run build` in this environment**.
