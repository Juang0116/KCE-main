...
- Replaced multiple public-facing `quiz/matcher/conversion` references with `Plan personalizado`,
  `tailored plan`, or clearer traveler-facing language.
- Cleaned copy in:
...
Make the public layer sound less like internal growth/CRO language and more like a premium travel
brand with guided planning.

## Validation

This deliverable was patched directly on the codebase but was not fully validated here with
`npm run build`.
