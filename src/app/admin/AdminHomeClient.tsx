    ...
    items: [
      {
        ...
        icon: BarChart3,
        label: 'Analytics',
        desc: 'Métricas del negocio',
      },
      {
        href: '/admin/conversations',
        icon: MessageSquare,
        label: 'Conversaciones',
        desc: 'Historial de chats',
      },
...
const COLOR: Record<string, string> = {
  ...
  orange:
    'border-orange-200 bg-orange-50 hover:bg-orange-100 dark:border-orange-900 dark:bg-orange-950/40',
  purple:
    'border-purple-200 bg-purple-50 hover:bg-purple-100 dark:border-purple-900 dark:bg-purple-950/40',
  green:
    'border-emerald-200 bg-emerald-50 hover:bg-emerald-100 dark:border-emerald-900 dark:bg-emerald-950/40',
  yellow:
    'border-yellow-200 bg-yellow-50 hover:bg-yellow-100 dark:border-yellow-900 dark:bg-yellow-950/40',
