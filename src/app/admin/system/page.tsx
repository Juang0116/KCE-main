  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        <a
          className="rounded-2xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-4 shadow-sm dark:bg-[var(--brand-dark)]"
          href="/admin/system/security"
        >
          <div className="text-sm font-semibold">Seguridad</div>
          <div className="text-[color:var(--color-text)]/70 mt-1 text-xs">
            Enforcement, disclosure, CI audits
          </div>
        </a>
        <a
          className="rounded-2xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-4 shadow-sm dark:bg-[var(--brand-dark)]"
          href="/admin/system/dr"
        >
          <div className="text-sm font-semibold">DR</div>
          <div className="text-[color:var(--color-text)]/70 mt-1 text-xs">
            Simulacros + frescura de backups
          </div>
        </a>
        <a
          className="rounded-2xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-4 shadow-sm dark:bg-[var(--brand-dark)]"
        ...
        >
          ...
          <div className="text-[color:var(--color-text)]/70 mt-1 text-xs">Bitácora de backups</div>
        </a>
        <a
          className="rounded-2xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-4 shadow-sm dark:bg-[var(--brand-dark)]"
      ...
      <div className="mt-8 rounded-2xl border border-black/10 p-4 text-sm dark:border-white/10">
        ...
        <ul className="text-[color:var(--color-text)]/80 mt-2 list-disc space-y-1 pl-5">
          ...
          <li>
            Remote:{' '}
            <code className="rounded bg-black/5 px-1 py-0.5">BASE_URL=... npm run qa:p71</code>
          </li>
          <li>
