...
export const metadata: Metadata = {
  ...
  description:
    'Gestión de hilos de conversación y soporte inteligente para Knowing Cultures S.A.S.',
...
export default async function AdminConversationPage({
  ...
  return (
    <main className="animate-in fade-in slide-in-from-bottom-4 mx-auto max-w-7xl space-y-4 p-4 pb-24 duration-1000 md:p-6">
      ...
      <footer className="flex flex-col items-center justify-center gap-8 border-t border-brand-dark/10 pt-10 opacity-40 transition-opacity duration-500 hover:opacity-100 dark:border-white/10 sm:flex-row">
