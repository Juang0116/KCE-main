      ...
      <form onSubmit={onSubmit} className="grid gap-10 lg:grid-cols-[1fr_380px] items-start">
        ...
        <aside className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  className="w-full h-12 rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] px-4 text-sm font-bold text-brand-blue outline-none cursor-pointer"
                  disabled={loading}
                >
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full h-12 rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] px-4 text-xs font-mono text-brand-blue outline-none focus:ring-2 focus:ring-brand-blue/5"
                  disabled={loading}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="min-h-[100px] w-full rounded-2xl border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] p-4 text-xs font-light leading-relaxed outline-none focus:ring-2 focus:ring-brand-blue/5 resize-none"
                  disabled={loading}
                />
              </div>
            </div>
          ...
          <div className="rounded-[2.5rem] bg-brand-yellow/5 border border-brand-yellow/20 p-8">
             <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-[color:var(--color-text)] opacity-60 mb-3">
                <CheckCircle2 className="h-3.5 w-3.5" /> Consejo Editorial
             </div>
             <p className="text-[11px] text-[color:var(--color-text)]/70 font-light leading-relaxed">
