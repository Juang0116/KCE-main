...
function pickImage(images: unknown) {
  ...
  return (
    absoluteUrl(url) || absoluteUrl('/images/hero-kce.jpg') || `${baseUrl()}/images/hero-kce.jpg`
  );
}
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(180deg, rgba(11,18,32,0) 0%, rgba(11,18,32,0.4) 40%, rgba(11,18,32,0.95) 100%)',
        }}
      />
      <div
        style={{
          ...
          inset: 0,
          background:
            'radial-gradient(1200px 800px at 0% 100%, rgba(13,91,161,0.6), transparent 100%)',
        }}
      />
