    ...
    <PageShell className="mx-auto w-full max-w-[var(--container-max)] px-6 py-12 md:py-20 pb-[calc(10rem+env(safe-area-bottom))] animate-fade-in">
      ...
      <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-[color:var(--color-border)] pb-8">
        <div>
          ...
          <div className="mt-4 flex items-center gap-2 text-sm font-light text-[color:var(--color-text-muted)]">
            <span className="opacity-70">ID de Referencia:</span>
            <div className="flex items-center gap-1 rounded-md border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] px-2 py-1 font-mono text-[11px] font-medium text-[color:var(--color-text)] shadow-sm">
        ...
        <div className="hidden md:flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-[color:var(--color-surface-2)] border border-[color:var(--color-border)] shadow-soft transition-transform hover:scale-105 group">
          <MessagesSquare className="h-8 w-8 text-[color:var(--color-text-muted)] opacity-50 group-hover:text-brand-blue group-hover:opacity-100 transition-colors" />
        </div>
      </header>
      ...
      <section className="mb-16 rounded-[var(--radius-2xl)] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] shadow-soft overflow-hidden">
