...
export default function Head() {
  ...
  const description =
    'Gestiona tus preferencias de privacidad. En Knowing Cultures S.A.S. (KCE) protegemos tu navegación bajo estándares internacionales de seguridad.';
  ...
  return (
    <>
      ...
      <meta
        name="author"
        content="Knowing Cultures S.A.S."
      />
      <meta
        name="publisher"
        content="Knowing Cultures S.A.S."
      ...
      <meta
        ...
        content="KCE • Knowing Cultures S.A.S."
      />
      <meta
        property="og:locale"
        content="es_CO"
