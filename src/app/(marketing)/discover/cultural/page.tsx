          ...
          <div className="grid lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="p-10 md:p-16">
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                <div className="rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-surface-2)] p-5 transition-colors hover:border-brand-yellow/50 hover:bg-brand-yellow/5">
                  <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--color-text)]/50 mb-2">Meaningful travel</div>
                  <div className="text-base font-heading text-brand-blue leading-tight">Context-rich routes</div>
                </div>
                <div className="rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-surface-2)] p-5 transition-colors hover:border-brand-yellow/50 hover:bg-brand-yellow/5">
                  <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--color-text)]/50 mb-2">Guided choice</div>
                  <div className="text-base font-heading text-brand-blue leading-tight">Clear next steps from content to booking</div>
                </div>
                <div className="rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-surface-2)] p-5 transition-colors hover:border-brand-yellow/50 hover:bg-brand-yellow/5">
                  <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--color-text)]/50 mb-2">Human support</div>
