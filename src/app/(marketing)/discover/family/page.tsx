...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical,
      languages: {
        es: withLocale('es', '/discover/family'),
        en: withLocale('en', '/discover/family'),
        fr: withLocale('fr', '/discover/family'),
        de: withLocale('de', '/discover/family'),
      },
    },
    openGraph: {
      title: 'Family-friendly Colombia planning with more clarity | KCE',
      description:
        'For parents and mixed-age groups who need safer, calmer and clearer trip planning.',
      url: `${base}${canonical}`,
      type: 'website',
    },
          ...
          <div className="grid lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="p-10 md:p-16">
              ...
              <p className="text-[color:var(--color-text)]/70 mt-6 max-w-xl text-lg font-light leading-relaxed">
                A calmer landing for parents and mixed-age groups who need clearer pacing, safer
                expectations and an easier path from research to shortlist.
              </p>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                <div className="rounded-[2rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] p-5 transition-colors hover:border-brand-blue/30">
                  ...
                  <div className="font-heading text-base leading-tight text-brand-blue">
                    Less friction, clearer next steps
                  </div>
                </div>
                <div className="rounded-[2rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] p-5 transition-colors hover:border-brand-blue/30">
                  <div className="text-[color:var(--color-text)]/50 mb-2 text-[10px] font-bold uppercase tracking-[0.2em]">
                  ...
                  <div className="font-heading text-base leading-tight text-brand-blue">
                    A route that feels calmer and safer
                  </div>
                </div>
                <div className="rounded-[2rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] p-5 transition-colors hover:border-brand-blue/30">
                  <div className="text-[color:var(--color-text)]/50 mb-2 text-[10px] font-bold uppercase tracking-[0.2em]">
                  ...
                  <div className="font-heading text-base leading-tight text-brand-blue">
                    Human help when the plan gets complex
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col justify-center border-t border-white/10 bg-brand-blue p-10 text-white md:p-16 lg:border-l lg:border-t-0">
              <div className="mb-8 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-inner backdrop-blur-sm">
                ...
                <h3 className="mb-3 font-heading text-2xl leading-tight">
                  A calmer planning lane for parents and mixed-age groups
                </h3>
                <p className="text-sm font-light leading-relaxed text-white/80">
                  Use this page when the buyer needs clearer structure, steadier pacing and a
                  lower-friction path to compare options.
                </p>
              </div>
              ...
              <div className="space-y-6 border-l border-white/20 pl-2">
                <div className="pl-4">
                  ...
                  <p className="text-sm font-light leading-relaxed text-white/60">
                    Family planning is rarely impulsive. A clearer path and visible support reduce
                    drop-off before the traveler is ready.
                  </p>
                </div>
                <div className="pl-4">
                  <div className="mb-1 text-sm font-bold text-white">How to continue</div>
                  <p className="text-sm font-light leading-relaxed text-white/60">
                    Use the personalized plan to clarify pace, comfort and style preferences, then
                    continue to tours or human planning help.
                  </p>
                </div>
                <div className="pl-4">
                  <div className="mb-1 text-sm font-bold text-white">Best for</div>
                  <p className="text-sm font-light leading-relaxed text-white/60">
                    Useful for family SEO pages, partnerships and ads that promise a smoother, safer
                    and more guided Colombia route.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-10 flex flex-col justify-between gap-6 border-b border-[color:var(--color-border)] pb-6 sm:flex-row sm:items-end">
            <div>
              ...
              <h2 className="font-heading text-3xl text-[color:var(--color-text)] md:text-4xl">
                Tours to begin a calmer conversation
              </h2>
            </div>
            <Link
