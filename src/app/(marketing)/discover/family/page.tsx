            ...
            <div className="p-10 md:p-16">
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                <div className="rounded-[2rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] p-5 transition-colors hover:border-brand-blue/30">
                  <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[color:var(--color-text)]/50 mb-2">Clarity</div>
                  <div className="text-base font-heading text-brand-blue leading-tight">Less friction, clearer next steps</div>
                </div>
                <div className="rounded-[2rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] p-5 transition-colors hover:border-brand-blue/30">
                  <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[color:var(--color-text)]/50 mb-2">Mixed ages</div>
                  <div className="text-base font-heading text-brand-blue leading-tight">A route that feels calmer and safer</div>
                </div>
                <div className="rounded-[2rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] p-5 transition-colors hover:border-brand-blue/30">
                  <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[color:var(--color-text)]/50 mb-2">Support</div>
        ...
        <section className="mt-20">
          <div className="mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-b border-[color:var(--color-border)] pb-6">
            <div>
              ...
              <h2 className="font-heading text-3xl md:text-4xl text-[color:var(--color-text)]">Tours to begin a calmer conversation</h2>
            </div>
