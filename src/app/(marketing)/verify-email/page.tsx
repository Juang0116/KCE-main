...
export default function VerifyEmailPage() {
  return (
    <PageShell className="bg-[color:var(--color-bg)] min-h-screen flex flex-col items-center justify-center px-6 py-12 animate-fade-in">
      ...
      <div className="w-full max-w-[480px]">
        ...
        <header className="mb-12 text-center flex flex-col items-center">
          <div className="relative mb-8 group">
            ...
            <div className="relative flex h-20 w-20 items-center justify-center rounded-3xl bg-[color:var(--color-surface)] border border-[color:var(--color-border)] text-brand-blue shadow-soft transition-transform duration-500 group-hover:-translate-y-1">
              <Fingerprint className="h-10 w-10 stroke-[1.5px]" />
            </div>
          </div>
          
          <h1 className="font-heading text-4xl text-[color:var(--color-text)] tracking-tight mb-4">
            Validación de <br />
            <span className="text-brand-blue italic font-light">Credenciales.</span>
          </h1>
          
          <p className="text-base font-light text-[color:var(--color-text-muted)] leading-relaxed max-w-[320px]">
            Estamos asegurando tu identidad para habilitar tu acceso al ecosistema de KCE.
          </p>
        </header>

        {/* 02. THE VALIDATION VAULT */}
        <div className="overflow-hidden rounded-[var(--radius-2xl)] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] shadow-pop relative group">
          ...
          <div className="bg-[color:var(--color-surface-2)]/50 border-t border-[color:var(--color-border)] px-10 py-4 flex items-center justify-center gap-3">
             <ShieldCheck className="h-3.5 w-3.5 text-brand-blue opacity-40" />
             <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-[color:var(--color-text-muted)] opacity-50">
        ...
        <footer className="mt-12 text-center">
          <div className="inline-flex flex-col items-center gap-6">
            ...
            <div className="space-y-4">
              <p className="text-[10px] text-[color:var(--color-text-muted)] uppercase tracking-[0.2em] font-medium leading-loose opacity-60">
              ...
              <p className="text-[9px] text-[color:var(--color-text-muted)]/30 uppercase tracking-[0.3em] font-bold italic">
