        ...
        markets: [
          {
            ...
            href: withLocale(locale, '/discover/uk'),
            hint: 'City breaks, premium planning, reassurance-first copy.',
          },
          {
            label: 'France',
            href: withLocale(locale, '/discover/france'),
            hint: 'Culture, gastronomy and a more editorial shortlist style.',
          },
          {
            label: 'Germany',
            href: withLocale(locale, '/discover/germany'),
            hint: 'Clarity, structure, trust and nature-forward positioning.',
          },
        ],
        lanes: [
          {
            ...
            body: 'Match the market page to campaigns, affiliates, travel content and cold traffic routes.',
          },
          {
            kicker: 'Nurture',
            title: 'Lead magnet + newsletter',
            body: 'Keep undecided visitors in the KCE system until they are ready for tours, matcher or a human conversation.',
          },
          {
            kicker: 'Close',
            title: 'WhatsApp + secure checkout',
            body: 'Give stronger-intent travelers a clean route to shortlist, chat and book without losing confidence.',
          },
        ],
        ctas: [
        ...
        markets: [
          {
            label: 'Royaume-Uni',
            href: withLocale(locale, '/discover/uk'),
            hint: 'City breaks, cadrage premium et rassurance.',
          },
          {
            label: 'France',
            href: withLocale(locale, '/discover/france'),
            hint: 'Culture, gastronomie et shortlist plus éditoriale.',
          },
          {
            label: 'Allemagne',
            href: withLocale(locale, '/discover/germany'),
            hint: 'Clarté, structure, confiance et nature.',
          },
        ],
        lanes: [
          {
            kicker: 'Acquisition',
            title: 'Search + partenaires',
            body: 'Associe chaque page marché à des campagnes, affiliés et contenus adaptés.',
          },
          {
            kicker: 'Nurture',
            title: 'Lead magnet + newsletter',
            body: 'Garde le visiteur indécis dans le système KCE jusqu’au matcher, aux tours ou au handoff humain.',
          },
          {
            kicker: 'Conversion',
            title: 'WhatsApp + checkout sécurisé',
            body: 'Donne une route claire vers shortlist, conversation et réservation.',
          },
        ],
        ctas: [
        ...
        markets: [
          {
            ...
            href: withLocale(locale, '/discover/uk'),
            hint: 'City breaks, Premium-Planung und starke Orientierung.',
          },
          {
            label: 'Frankreich',
            href: withLocale(locale, '/discover/france'),
            hint: 'Kultur, Gastronomie und editoriale Shortlist.',
          },
          {
            label: 'Deutschland',
            href: withLocale(locale, '/discover/germany'),
            hint: 'Struktur, Vertrauen und naturorientierte Positionierung.',
          },
        ],
        lanes: [
          {
            ...
            body: 'Verbinde jede Marktseite mit Kampagnen, Affiliates und passenden Content-Einstiegen.',
          },
          {
            kicker: 'Nurture',
            title: 'Lead Magnet + Newsletter',
            body: 'Halte unsicheren Traffic im KCE-System bis zu Matcher, Touren oder menschlichem Handoff.',
          },
          {
            kicker: 'Close',
            title: 'WhatsApp + sicherer Checkout',
            body: 'Gib Nutzern mit stärkerer Absicht einen klaren Weg zu Shortlist, Gespräch und Buchung.',
          },
        ],
        ctas: [
        ...
        markets: [
          {
            label: 'Reino Unido',
            href: withLocale(locale, '/discover/uk'),
            hint: 'City breaks, planeación premium y copy de confianza.',
          },
          {
            label: 'Francia',
            href: withLocale(locale, '/discover/france'),
            hint: 'Cultura, gastronomía y shortlist más editorial.',
          },
          {
            label: 'Alemania',
            href: withLocale(locale, '/discover/germany'),
            hint: 'Claridad, estructura, confianza y posicionamiento nature-first.',
          },
        ],
        lanes: [
          {
            kicker: 'Atraer',
            title: 'Search + partnerships',
            body: 'Conecta cada página mercado con campañas, afiliados, contenido y rutas de tráfico frío.',
          },
          {
            kicker: 'Nutrir',
            title: 'Lead magnet + newsletter',
            body: 'Mantén al visitante indeciso dentro del sistema KCE hasta que esté listo para tours, matcher o conversación humana.',
          },
          {
            kicker: 'Cerrar',
            title: 'WhatsApp + checkout seguro',
            body: 'Da una ruta clara a shortlist, chat y compra sin perder confianza.',
          },
        ],
        ctas: [
  ...
  return (
    ...
    >
      <div className="border-b border-[color:var(--color-border)] px-6 py-6 sm:px-8">
        ...
        <h2 className="mt-3 font-heading text-[1.9rem] leading-[0.98] text-brand-blue md:text-[2.3rem]">
          {copy.title}
        </h2>
      ...
      <div className="grid gap-4 px-6 py-6 sm:px-8 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="space-y-3">
          {copy.markets.map((market) => (
            ...
            >
              <div>
                <div className="text-[color:var(--color-text)]/55 text-[11px] font-semibold uppercase tracking-[0.18em]">
                  Market lane
                </div>
                <div className="mt-2 text-lg font-semibold tracking-tight text-[color:var(--color-text)]">
                  {market.label}
                </div>
                <p className="text-[color:var(--color-text)]/72 mt-1 text-sm leading-6">
                  {market.hint}
                </p>
              </div>
              <div className="pt-1 text-lg font-semibold text-brand-blue transition group-hover:translate-x-0.5">
                →
              </div>
            </Link>
          ))}
        ...
        <div className="rounded-[1.35rem] border border-transparent bg-[linear-gradient(155deg,rgba(6,29,61,0.98),rgba(10,69,135,0.95)_62%,rgba(216,176,74,0.74))] p-5 text-white shadow-soft">
          <div className="grid gap-4">
            {copy.lanes.map((lane) => (
              <div
                key={lane.title}
                className="border-white/12 bg-white/8 rounded-[1.05rem] border p-4"
              >
                <div className="text-white/68 text-[11px] font-semibold uppercase tracking-[0.18em]">
                  {lane.kicker}
                </div>
                <div className="mt-2 text-lg font-semibold tracking-tight">{lane.title}</div>
                <p className="text-white/82 mt-2 text-sm leading-6">{lane.body}</p>
              </div>
            ))}
              ...
              {copy.ctas.map((cta) =>
                cta.external ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="border-white/18 hover:bg-white/14 inline-flex items-center rounded-full border bg-white/10 px-4 py-2.5 text-sm font-semibold text-white transition"
                  >
                    {cta.label}
                  </a>
                ) : (
