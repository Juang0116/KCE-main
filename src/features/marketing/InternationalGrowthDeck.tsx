  ...
  switch (locale) {
        ...
        cards: [
          {
            ...
            copy: 'Send high-intent traffic straight to curated tours and secure checkout.',
            cta: 'Open tours',
            href: withLocale(locale, '/tours'),
          },
          {
            title: 'Tailored plan',
            copy: 'Help undecided travelers describe what they want before you send them to a tour or to support.',
            cta: 'Start planning',
            href: withLocale(locale, '/plan'),
          },
          {
            title: 'EU lead magnet',
            copy: 'Capture early-stage intent with a practical Europe → Colombia planning asset.',
            cta: 'Open the guide',
            href: withLocale(locale, '/lead-magnets/eu-guide'),
          },
          {
            title: 'Human handoff',
            copy: 'When confidence needs a real person, route the traveler to WhatsApp or contact.',
            cta: 'Talk to KCE',
            href: contactHref,
    ...
    case 'fr':
      return {
        ...
        title:
          'Des points d’entrée internationaux pensés pour transformer l’attention en demande qualifiée.',
        subtitle:
        ...
        cards: [
          {
            ...
            copy: 'Envoie le trafic à forte intention vers des tours curés et un checkout sécurisé.',
            cta: 'Voir les tours',
            href: withLocale(locale, '/tours'),
          },
          {
            title: 'Tailored plan',
            copy: 'Aide les voyageurs indécis à décrire ce qu’ils veulent avant de les envoyer vers un tour ou vers le support.',
            cta: 'Commencer',
            href: withLocale(locale, '/plan'),
          },
          {
            title: 'Lead magnet EU',
            copy: 'Capte l’intention tôt avec un guide pratique Europe → Colombie.',
            cta: 'Ouvrir le guide',
            href: withLocale(locale, '/lead-magnets/eu-guide'),
          },
          {
            title: 'Handoff humain',
            copy: 'Quand la confiance demande une vraie personne, redirige vers WhatsApp ou contact.',
            cta: 'Parler à KCE',
            href: contactHref,
            external: !!whatsAppHref,
          },
    ...
    case 'de':
      return {
        eyebrow: 'KCE growth routes',
        title:
          'Internationale Einstiegspunkte, die Aufmerksamkeit in qualifizierte Nachfrage verwandeln.',
        subtitle:
        ...
        cards: [
          {
            ...
            copy: 'Leite kaufbereiten Traffic direkt zu kuratierten Touren und sicherem Checkout.',
            cta: 'Touren öffnen',
            href: withLocale(locale, '/tours'),
          },
          {
            title: 'Tailored plan',
            copy: 'Hilf unentschlossenen Reisenden zuerst zu beschreiben, was sie suchen, bevor du sie zu einer Tour oder zum Support leitest.',
            cta: 'Plan starten',
            href: withLocale(locale, '/plan'),
          },
          {
            title: 'EU Lead Magnet',
            copy: 'Fange frühe Absicht mit einem praktischen Europa → Kolumbien Guide ab.',
            cta: 'Guide öffnen',
            href: withLocale(locale, '/lead-magnets/eu-guide'),
          },
          {
            title: 'Menschlicher Handoff',
            copy: 'Wenn Vertrauen eine echte Person braucht, leite zu WhatsApp oder Kontakt.',
            cta: 'Mit KCE sprechen',
            href: contactHref,
            external: !!whatsAppHref,
          },
        ],
        ...
        cards: [
          {
            ...
            copy: 'Empuja tráfico de alta intención a tours curados, shortlist clara y checkout seguro.',
            cta: 'Ver tours',
            href: withLocale(locale, '/tours'),
          },
          {
            title: 'Tailored plan',
            copy: 'Ayuda al viajero indeciso a describir mejor lo que quiere antes de llevarlo a un tour o a soporte.',
            cta: 'Abrir plan',
            href: withLocale(locale, '/plan'),
          },
          {
            title: 'Lead magnet EU',
            copy: 'Captura intención temprana con una guía práctica Europa → Colombia que alimenta CRM.',
            cta: 'Abrir guía',
            href: withLocale(locale, '/lead-magnets/eu-guide'),
          },
          {
            title: 'Handoff humano',
            copy: 'Cuando hace falta confianza real, lleva al viajero a WhatsApp o contacto sin romper el contexto.',
            cta: 'Hablar con KCE',
            href: contactHref,
            external: !!whatsAppHref,
          },
...
export default function InternationalGrowthDeck({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'grid gap-0 lg:grid-cols-[0.92fr_1.08fr]',
          compact && 'lg:grid-cols-[0.86fr_1.14fr]',
        )}
      >
        <div className="border-b border-[color:var(--color-border)] bg-[linear-gradient(155deg,rgba(6,29,61,0.98),rgba(10,69,135,0.95)_60%,rgba(216,176,74,0.76))] px-6 py-7 text-white lg:border-b-0 lg:border-r lg:px-8">
          <div className="border-white/14 text-white/78 inline-flex rounded-full border bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em]">
            {copy.eyebrow}
          </div>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {copy.proof.map((item) => (
              <span
                key={item}
                className="border-white/14 text-white/84 rounded-full border bg-white/10 px-3 py-1.5 text-xs font-semibold"
              >
                {item}
              </span>
            ))}
          ...
          <div className={clsx('grid gap-4 md:grid-cols-2', compact && 'gap-3')}>
            {copy.cards.map((card, idx) => {
              const classes = clsx(
                ...
                idx === 1 &&
                  'border-transparent bg-[linear-gradient(145deg,rgba(11,84,162,0.94),rgba(10,69,135,0.88)_58%,rgba(216,176,74,0.55))] text-white',
              );
                ...
                <>
                  <div
                    className={clsx(
                      ...
                      idx === 1 ? 'text-white/70' : 'text-brand-blue/80',
                    )}
                  >
                    0{idx + 1}
                  </div>
                  ...
                  <p
                    className={clsx(
                      ...
                      idx === 1 ? 'text-white/78' : 'text-[color:var(--color-text)]/74',
                    )}
                  >
                    {card.copy}
                  </p>
                  <div
                    className={clsx(
                      ...
                      idx === 1 ? 'text-white' : 'text-brand-blue',
                    )}
                  >
                    {card.cta}
                    <span
