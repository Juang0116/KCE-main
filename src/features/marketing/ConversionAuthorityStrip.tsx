      ...
      <div className={clsx('grid gap-0 lg:grid-cols-[0.96fr_1.04fr]', compact ? 'min-h-0' : 'min-h-[22rem]')}>
        <div className="bg-[linear-gradient(165deg,rgba(6,29,61,0.98),rgba(10,69,135,0.95)_58%,rgba(216,176,74,0.72))] p-7 text-white md:p-9">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href={withLocale(locale, '/tours')} className="inline-flex items-center rounded-full bg-[color:var(--color-surface)] px-5 py-3 text-sm font-semibold text-[color:var(--color-text)] shadow-soft transition hover:-translate-y-px">
              {copy.primary}
            </Link>
