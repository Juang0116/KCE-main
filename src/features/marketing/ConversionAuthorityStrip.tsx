  ...
  switch (locale) {
    case 'en':
      return {
        ...
        body: 'When traffic is stronger and intent is warmer, the traveler should feel guided by authority: a clearer shortlist, calmer booking path and visible human support.',
    ...
    case 'fr':
      return {
        ...
        body: 'Quand le trafic est plus fort et l’intention plus chaude, le voyageur doit sentir une vraie autorité: shortlist plus nette, réservation plus calme et aide humaine visible.',
        primary: 'Voir les tours',
        secondary: 'Ouvrir discover',
        tertiary: 'Parler sur WhatsApp',
        lanes: [
          {
            kicker: '01 · Shortlist plus forte',
            title: 'Moins d’options, mais meilleures',
            body: 'Fais avancer le voyageur dans la bonne voie au lieu de le laisser dans un browse trop générique.',
          },
          {
            kicker: '02 · Certitude premium',
            title: 'Montrer la confiance avant la friction',
            body: 'Affiche la réservation sécurisée, le support humain et le calme de la livraison avant que le doute n’apparaisse.',
            highlight: true,
          },
          {
            kicker: '03 · Sauvetage humain',
            title: 'Garder l’aide humaine élégante',
            body: 'Si le voyageur hésite, l’aide doit sembler intégrée au flux premium, pas improvisée.',
          },
        ],
      };
    case 'de':
      return {
        ...
        body: 'Wenn Traffic stärker und Absicht wärmer wird, sollte der Reisende echte Orientierung spüren: klarere Shortlist, ruhigere Buchung und sichtbare menschliche Hilfe.',
        primary: 'Touren ansehen',
        secondary: 'Discover öffnen',
        tertiary: 'Per WhatsApp sprechen',
        lanes: [
          {
            kicker: '01 · Stärkere Shortlist',
            title: 'Weniger, aber bessere nächste Schritte',
            body: 'Halte den Reisenden im bestpassenden Pfad statt in generischem Browsing.',
          },
          {
            kicker: '02 · Premium-Sicherheit',
            title: 'Vertrauen vor Reibung sichtbar machen',
            body: 'Zeige sichere Buchung, Beratung und Delivery-Ruhe bevor Zweifel entstehen.',
            highlight: true,
          },
          {
            kicker: '03 · Menschliche Hilfe',
            title: 'Den Rettungspfad elegant halten',
            body: 'Wenn der Reisende zögert, sollte Hilfe Teil des Premium-Flows bleiben.',
          },
        ],
      };
    default:
      return {
        ...
        body: 'Cuando el tráfico entra mejor y la intención ya está más caliente, el viajero debe sentir una autoridad clara: shortlist más firme, reserva más calmada y ayuda humana visible.',
        primary: 'Ver tours',
...
export default function ConversionAuthorityStrip({
  locale,
  whatsAppHref,
  className,
  compact = false,
