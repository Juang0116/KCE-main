    ...
    >
      <div className="grid gap-0 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="p-7 md:p-9">
          ...
          <h2 className="mt-4 max-w-2xl font-heading text-2xl tracking-tight text-brand-blue md:text-[2.15rem]">
            {c.title}
          </h2>
          <p className="text-[color:var(--color-text)]/72 mt-3 max-w-2xl text-sm leading-6 md:text-[15px]">
            {c.body}
          </p>
        ...
        <div className="border-t border-brand-blue/10 bg-[linear-gradient(160deg,rgba(6,29,61,0.98),rgba(10,69,135,0.94)_60%,rgba(216,176,74,0.72))] p-7 text-white md:p-9 lg:border-l lg:border-t-0">
          <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
            {c.cards.map((card, idx) => (
              <div
                key={card}
                className="border-white/12 rounded-3xl border bg-white/10 p-4 backdrop-blur"
              >
                <div className="text-white/62 text-[11px] uppercase tracking-[0.18em]">
                  0{idx + 1}
                </div>
