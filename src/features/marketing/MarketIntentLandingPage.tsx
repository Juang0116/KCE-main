    ...
    <main className='mx-auto w-full max-w-6xl px-4 pb-16 pt-28'>
      <section className='overflow-hidden rounded-[calc(var(--radius)+0.55rem)] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] shadow-soft'>
        <div className='grid gap-0 lg:grid-cols-[1.15fr_0.85fr]'>
          <div className='p-6 sm:p-8 lg:p-10'>
            ...
            <p className='mt-4 max-w-2xl text-base leading-7 text-[color:var(--color-text)]/75'>{config.description}</p>
      ...
      <section className='mt-10'>
        <div className='mb-4 flex items-end justify-between gap-4'>
          <div>
            <div className='text-[11px] font-semibold uppercase tracking-[0.18em] text-[color:var(--color-text)]/55'>Tours sugeridos</div>
            <h2 className='mt-2 font-heading text-2xl tracking-tight text-brand-blue'>{config.shortlistTitle}</h2>
          </div>
          <Link href={withLocale(locale, '/tours')} className='text-sm font-semibold text-brand-blue'>Ver catálogo completo →</Link>
        </div>
      ...
      <section className='mt-10 rounded-[calc(var(--radius)+0.35rem)] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-6 shadow-soft'>
        <div className='grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center'>
          <div>
            ...
            <h2 className='mt-2 text-2xl font-semibold tracking-tight text-[color:var(--color-text)]'>{config.closeTitle}</h2>
            <p className='mt-2 max-w-3xl text-sm leading-6 text-[color:var(--color-text)]/70'>{config.closeBody}</p>
          </div>
