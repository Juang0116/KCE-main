...
export default function RevenuePolishDeck({
  ...
  return (
    <section className="rounded-brand-2xl border border-brand-dark/10 bg-[linear-gradient(135deg,rgba(10,61,128,0.05),rgba(216,176,74,0.05),rgba(255,255,255,0.95))] p-6 shadow-soft backdrop-blur-sm md:p-10">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="rounded-2xl border border-brand-blue/5 bg-white/60 p-5 text-sm shadow-hard backdrop-blur-md">
          <p className="font-medium italic text-brand-blue/80">
      ...
      <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {cards.map((card) => {
          ...
          return (
            ...
            >
              <div className="text-muted/40 flex items-center gap-3 transition-colors group-hover:text-brand-blue">
              ...
              <div className="mt-5 flex-1">
                <h3 className="font-heading text-lg font-bold text-brand-blue">{card.title}</h3>
