...
const rails = [
  [
    'Launch fewer messages, better',
    'Cuando todo es urgente, se pierde la narrativa. Elige un carril de mercado y uno de soporte que importen esta semana.',
  ],
  [
    'Make recovery obvious',
    'Si una reserva falla, la acción correctiva debe ser visible de inmediato en QA, Revenue o Bookings.',
  ],
  [
    'Protect confidence after the click',
    'El crecimiento internacional solo escala si el viajero se siente guiado después del pago, no solo antes.',
  ],
] as const;
