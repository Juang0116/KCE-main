  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        secondary:
          'bg-brand-yellow text-brand-blue shadow-soft hover:bg-brand-yellow/90 hover:shadow-pop',
        outline:
          'border border-brand-dark/10 bg-[color:var(--color-surface)] text-brand-blue hover:bg-brand-dark/5',
  ...
  (
    ...
    return (
      <Comp
        ...
        {...(asChild ? { 'aria-disabled': _disabled || undefined } : { disabled: _disabled })}
        {...props}
      >
