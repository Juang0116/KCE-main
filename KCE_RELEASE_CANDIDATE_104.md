...
Cerrar la fase de **QA / launch readiness** para que KCE se lea y opere más como una empresa lista
para lanzar, no solo como una web avanzada.
...
- **Recover**: si hay huecos puntuales, usar heal booking / resend email / runbooks antes de empujar
