...
Cerrar mejor el loop entre revenue, bookings, account y soporte para que KCE se sienta más premium
también después de la compra.
...
- `AdminBookingsClient` incluye summary cards para paid/pending/session trace dentro del corte
  actual.
