...
**Cuándo aplica:** Cada vez que llega un contacto por chat, formulario /plan, /contact, WhatsApp o
email.
...
**Regla de oro:** La propuesta es para este viajero, no genérica. Personaliza al menos una frase por
tour.
...
2. Generar invoice.
3. Enviar email de confirmación con: booking ID, invoice, fechas, detalle del tour, contacto de
   soporte.
...
**Regla de oro:** Un solo hilo por caso. No abrir canales paralelos. No prometer refunds sin
...
1. Notificar al guía/proveedor con: fecha, hora, punto de encuentro, número de personas, idioma del
   grupo, contacto del cliente.
...
- Revisar catálogo: ¿hay tours que no se están vendiendo? ¿hay tours que necesitan actualización de
  precio?
...
_Última actualización: Phase 120 — KCE_
