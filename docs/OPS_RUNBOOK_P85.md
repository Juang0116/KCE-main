...
Este bloque completa lo que faltaba para “internacional 10/10” en **go-to-market + compliance +
performance**:
...
- Cookie: `kce.ref`
- Endpoint click: `POST /api/affiliates/click` (se invoca desde frontend si quieres, pero ya con la
  cookie basta)
