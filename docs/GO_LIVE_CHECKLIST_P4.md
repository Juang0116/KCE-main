...
Este checklist es para cerrar "security + RBAC + panel consistente" antes de activar
**RBAC_REQUIRED=1** en producción.
...
- Con `SIGNED_ACTIONS_MODE=soft`, revisar logs de eventos: qué rutas mutan y si están
  pidiendo/recibiendo firmas
