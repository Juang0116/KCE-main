...
Este documento define **(1) meta**, **(2) estado actual**, **(3) estrategia de ejecución**, y **(4)
roadmap priorizado** para llegar rápido a un KCE “empresa internacional 10/10”, sin perder
...
- Un usuario entra, descubre tours reales, compra en Stripe, recibe confirmación + factura +
  calendario, y el equipo puede dar soporte/hacer seguimiento desde el CRM.
...
- Bot/IA: crea conversación + mensajes; crea **ticket** cuando pide humano; crea **deal** cuando hay
  intención de compra; crea **task** para follow-up.
