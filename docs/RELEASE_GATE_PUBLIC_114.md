...
Close a sharper release gate for the public-facing KCE core before opening more growth or editorial
surface.
...
- Tour detail does not trap hesitant users in a dead end; it offers reserve, guided plan, or human
  help.
...
3. Open any `/es/tours/[slug]` on mobile width.
   ...
   - Confirm the page still offers a visible way back to Destinations / Plan without abandoning the
     traveler.
