...
- Upgraded `MobileStickyBookingCta` so tour detail keeps reserve as the primary action but also
  offers `Plan primero` and contact/help as recovery lanes.
- Added `docs/RELEASE_GATE_PUBLIC_114.md` and updated release status / E2E QA notes.

## Intent

This phase does not open more product surface. It makes the public hierarchy clearer and safer for
launch, especially on mobile.
