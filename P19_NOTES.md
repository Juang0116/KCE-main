...
Objetivo: reducir _high_reply_low_paid_ atacando confianza y fricción en páginas clave (tour →
checkout → success), y habilitar medición por bloque/CTA (sin depender de adivinar).
