...
- Optional internal HMAC signing for internal/cron endpoints (`INTERNAL_HMAC_SECRET`,
  `INTERNAL_HMAC_REQUIRED=1`).
...
Set `INTERNAL_HMAC_SECRET` in Vercel. Compute headers:
