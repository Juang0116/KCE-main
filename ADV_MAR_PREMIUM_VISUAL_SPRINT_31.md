...
- `src/features/marketing/PremiumConversionStrip.tsx`
  - split visual más premium
  - rail derecho con card central destacada para el matcher
  - micro-panels más limpios y con mejor contraste

- `src/app/(marketing)/page.tsx`
  - trust blocks del hero más ricos y menos planos
  - nueva franja `KCE signature gateways` para dar sensación de marca editorial internacional

- `src/app/(marketing)/tours/page.tsx`
  - hero y browse rhythm más pulidos
  - quick chips más editoriales
