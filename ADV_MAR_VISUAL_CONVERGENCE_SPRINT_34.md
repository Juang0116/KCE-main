...
- Tours list simplificada:
  ...
  - se dejó una sola franja fuerte de conversión (`PremiumConversionStrip`)
- Tour detail refinado:
  - la navegación rápida ahora usa pills horizontales con scroll en mobile
  - mejor ritmo visual en la transición hero → navegación → contenido
  - se eliminó el `CaptureCtas` compacto al final para evitar repetición
- TourCardPremium más limpia:
  - menos tags visibles
  - menos ruido visual en chips inferiores
...
- mobile detail más limpio en la franja de navegación rápida
