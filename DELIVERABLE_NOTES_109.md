# Deliverable Notes 109

## Phase 109 — Public surface convergence / editorial rationalization
...
- Sitemap no longer promotes newsletter as part of the main indexed route set.
- `CURRENT_STATUS.md` and QA docs now reflect the convergence-first roadmap.
